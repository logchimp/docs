...
You can kick-start your LogChimp site in 3 easy steps.
...
<Steps>
	<Step>
		...
		curl -L -o docker-compose.yml \
			https://raw.githubusercontent.com/logchimp/logchimp/refs/tags/v0.8.0/docker/community/docker-compose.yml -o .env \
			https://raw.githubusercontent.com/logchimp/logchimp/refs/tags/v0.8.0/docker/community/.env.example
		```
	</Step>
	<Step>
		...
		<Alert type="tip">
			The secret key must be valid hexadecimal string. You can generate a secure and random key using the following
			command.
	...
	<Step>
		...
		```bash
		docker compose --file ./docker/local/docker-compose.yml --env-file ./.env up --detach
		```
	</Step>
</Steps>
