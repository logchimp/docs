...
There are many ways to [install LogChimp](/self-hosting/installation). With Railway, you can get started with just a few easy steps. Click the button[^1], and hit deploy. It's that simple.
