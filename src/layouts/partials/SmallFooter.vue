	...
	<footer>
		<div class="footer-container">
			<div class="footer-col">
				<logo />
				<p class="small-text">© Copyright {{ new Date().getFullYear() }} CodeCarrot, Inc</p>
			</div>

			<div class="footer-col">
				<nav class="footer-nav">
					<g-link class="footer-link" to="/partners">
						Partners
					</g-link>
					<g-link class="footer-link" to="/docs">
						Docs
					</g-link>
				</nav>
			</div>
			...
			<div class="footer-col">
				<div class="footer-social">
					<a href="https://github.com/logchimp/logchimp" class="footer-col-item">
